public class Exer_6DemoLLBaseballGame {
    ...
    private static class LittleLeagueBaseballGame {
        public static int UNPLAYED;

        public void setNames(String peeWees, String mighty_mice) {

        }

        public void setScore(int i, int i1, int i2) {
        ...
        public int getScore(int t, int i) {
            return 0;
        }
    }
