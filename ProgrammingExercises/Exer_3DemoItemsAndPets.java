public class Exer_3DemoItemsAndPets {
    ...
    public static void main(String[] args)
    {
        ...
        item1.setDescription("30 gallon aquarium");
    ...
    private static void display(PetSold pet1) {
    ...
    private static void displayPetData(PetSold item)
    {
    ...
    private static class ItemSold {
        void setInvoiceNumber(int i) {
    ...
    private static class PetSold {
        void setInvoiceNumber(int i) {

        }

        void setDescription(String standard_poodle) {
        ...
        void setIsVaccinated(boolean b) {

        }

        void setIsNeutered(boolean b) {

        }

        void setIsHousebroken(boolean b) {

        }

        String getIsVaccinated() {
            return null;
        }

        String getIsNeutered() {
            return null;
        }

        String getIsHousebroken() {
            return null;
        }
    }
}
